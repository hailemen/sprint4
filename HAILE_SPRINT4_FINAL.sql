...
# Para poder realizar la modificación de la tabla
...
FROM (
	 SELECT 1 as n UNION ALL SELECT 2 UNION ALL SELECT 3 UNION ALL SELECT 4 -- y así sucesivamente (la cantidad máxima de operaciones en una columna es de 4) 
    ) n
JOIN transactions t
...
/* Se declaran las FK para establecer las relación entre products y transactions */

ALTER TABLE comprados
ADD CONSTRAINT FOREIGN KEY(id) REFERENCES transactions(id),
